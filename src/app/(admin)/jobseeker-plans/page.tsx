...
export default function JobseekerPlansPage() {
    ...
    const jobseekerPlans = useMemo(() => 
        subscriptionPlans.filter(plan => plan.userTypes.includes('JobSeeker')), 
        []
    );

    const filteredAndSortedPlans = useMemo(() => {
        let sortedItems = [...jobseekerPlans];
        ...
        return sortedItems;
    }, [searchTerm, sortConfig, filters, jobseekerPlans]);
    ...
    return (
        <div>
            <PageHeader title="Jobseeker Subscription Plans">
                <Button asChild>
                    <Link href="/jobseeker-plans/new">
                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoading ? (
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/jobseeker-plans/${plan.id}/edit`}>
                            ...
                            <TableRow>
                                <TableCell colSpan={Object.values(columnVisibility).filter(Boolean).length} className="h-24 text-center">No jobseeker plans found.</TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                </Table>
