...
import { getSubAdminUsers, deleteSubAdminUser } from '@/services/api';
...
export default function SubAdminsPage() {
    ...
    const fetchAdmins = useCallback(() => {
        ...
        getSubAdminUsers(params)
            ...
            .catch(error => {
                toast({
                    title: 'Error fetching sub admins',
    ...
    const handleDelete = async (adminId: string) => {
        try {
            await deleteSubAdminUser(adminId);
            toast({
                title: 'Sub Admin Deleted',
                description: 'The sub admin has been successfully deleted.',
            });
            fetchAdmins();
        } catch (error: any) {
            toast({
             ...
             <div className="flex items-center justify-between mt-4">
                 <div className="text-sm text-muted-foreground">
                    {isLoading || !pagination ? (
                        ...
                        `Showing ${pagination.totalRecords === 0 ? 0 : (pagination.currentPage - 1) * pagination.limit + 1} to ${Math.min(pagination.currentPage * pagination.limit, pagination.totalRecords)} of ${pagination.totalRecords} sub admins.`
                    )}
                </div>
