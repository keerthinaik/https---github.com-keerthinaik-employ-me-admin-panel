...
export default function UniversityPlansPage() {
    ...
    const universityPlans = useMemo(() => 
        subscriptionPlans.filter(plan => plan.userTypes.includes('University')), 
        []
    );

    const filteredAndSortedPlans = useMemo(() => {
        let sortedItems = [...universityPlans];
        ...
        return sortedItems;
    }, [searchTerm, sortConfig, filters, universityPlans]);
    ...
    return (
        <div>
            <PageHeader title="University Subscription Plans">
                <Button asChild>
                    <Link href="/university-plans/new">
                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoading ? (
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/university-plans/${plan.id}/edit`}>
                            ...
                            <TableRow>
                                <TableCell colSpan={Object.values(columnVisibility).filter(Boolean).length} className="h-24 text-center">No university plans found.</TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                </Table>
