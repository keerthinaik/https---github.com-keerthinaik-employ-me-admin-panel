...
export default function BusinessPlansPage() {
    ...
    const businessPlans = useMemo(() => 
        subscriptionPlans.filter(plan => plan.userTypes.includes('Business')), 
        []
    );

    const filteredAndSortedPlans = useMemo(() => {
        let sortedItems = [...businessPlans];
        ...
        return sortedItems;
    }, [searchTerm, sortConfig, filters, businessPlans]);
    ...
    return (
        <div>
            <PageHeader title="Business Subscription Plans">
                <Button asChild>
                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoading ? (
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/business-plans/${plan.id}/edit`}>
                            ...
                            <TableRow>
                                <TableCell colSpan={Object.values(columnVisibility).filter(Boolean).length} className="h-24 text-center">No business plans found.</TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                </Table>
